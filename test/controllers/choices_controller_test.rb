...
class ChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post choices_url, params: { choice: { choice_body: @choice.choice_body, choice_score: @choice.choice_score, question_id: @choice.question_id } }
    end
  ...
  test "should update choice" do
    patch choice_url(@choice), params: { choice: { choice_body: @choice.choice_body, choice_score: @choice.choice_score, question_id: @choice.question_id } }
